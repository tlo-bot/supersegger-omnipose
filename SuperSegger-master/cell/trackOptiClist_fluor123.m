...
if isempty( contents )
    ...
    for i = 1:num_im
        ...
        if ~isempty( data_c.CellA)
            ...
            bgfl3 = drill(data_c.CellA, '.fl3.bg');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	    %fluor 2 intensities
            ...
            locus1_f2_L1 = drill(data_c.CellA, '.locus2(1).longaxis');
            locus1_f2_L2 = drill(data_c.CellA, '.locus2(1).shortaxis');
            locus1_f2_s = drill(data_c.CellA, '.locus2(1).score');
            locus1_f2_i = drill(data_c.CellA, '.locus2(1).intensity'); 
            
            locus2_f2_L1 = drill(data_c.CellA, '.locus2(2).longaxis');
            locus2_f2_L2 = drill(data_c.CellA, '.locus2(2).shortaxis');
            locus2_f2_s = drill(data_c.CellA, '.locus2(2).score');
            locus2_f2_i = drill(data_c.CellA, '.locus2(2).intensity');
            
            locus3_f2_L1 = drill(data_c.CellA, '.locus2(3).longaxis');
            locus3_f2_L2 = drill(data_c.CellA, '.locus2(3).shortaxis');
            locus3_f2_s = drill(data_c.CellA, '.locus2(3).score');
            locus3_f2_i = drill(data_c.CellA, '.locus2(3).intensity');
            
            locus4_f2_L1 = drill(data_c.CellA, '.locus2(4).longaxis');
            locus4_f2_L2 = drill(data_c.CellA, '.locus2(4).shortaxis');
            locus4_f2_s = drill(data_c.CellA, '.locus2(4).score');
            locus4_f2_i = drill(data_c.CellA, '.locus2(4).intensity');
            
            locus5_f2_L1 = drill(data_c.CellA, '.locus2(5).longaxis');
            locus5_f2_L2 = drill(data_c.CellA, '.locus2(5).shortaxis');
            locus5_f2_s = drill(data_c.CellA, '.locus2(5).score');
            locus5_f2_i = drill(data_c.CellA, '.locus2(5).intensity');
            
            
        %fluor 3 intensities
        
            locus1_f3_L1 = drill(data_c.CellA, '.locus3(1).longaxis');
            locus1_f3_L2 = drill(data_c.CellA, '.locus3(1).shortaxis');
            locus1_f3_s = drill(data_c.CellA, '.locus3(1).score');
            locus1_f3_i = drill(data_c.CellA, '.locus3(1).intensity'); 
            
            locus2_f3_L1 = drill(data_c.CellA, '.locus3(2).longaxis');
            locus2_f3_L2 = drill(data_c.CellA, '.locus3(2).shortaxis');
            locus2_f3_s = drill(data_c.CellA, '.locus3(2).score');
            locus2_f3_i = drill(data_c.CellA, '.locus3(2).intensity');
            
            locus3_f3_L1 = drill(data_c.CellA, '.locus3(3).longaxis');
            locus3_f3_L2 = drill(data_c.CellA, '.locus3(3).shortaxis');
            locus3_f3_s = drill(data_c.CellA, '.locus3(3).score');
            locus3_f3_i = drill(data_c.CellA, '.locus3(3).intensity');
            
            locus4_f3_L1 = drill(data_c.CellA, '.locus3(4).longaxis');
            locus4_f3_L2 = drill(data_c.CellA, '.locus3(4).shortaxis');
            locus4_f3_s = drill(data_c.CellA, '.locus3(4).score');
            locus4_f3_i = drill(data_c.CellA, '.locus3(4).intensity');
            
            locus5_f3_L1 = drill(data_c.CellA, '.locus3(5).longaxis');
            locus5_f3_L2 = drill(data_c.CellA, '.locus3(5).shortaxis');
            locus5_f3_s = drill(data_c.CellA, '.locus3(5).score');
            locus5_f3_i = drill(data_c.CellA, '.locus3(5).intensity');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            length1 = drill(data_c.CellA,'.length(1)'); %long axis length used for normalization
            %rel_len = length1./(max(length1,[],2)*ones([1,size(length1,2)])); %added
            length2 = drill(data_c.CellA,'.length(2)'); %short axis length used for normalization
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %fluor2 normalized axes
            locus1_f2_relL1 = (locus1_f2_L1)./length1;
            locus2_f2_relL1 = (locus2_f2_L1)./length1;
            locus3_f2_relL1 = (locus3_f2_L1)./length1;
            locus4_f2_relL1 = (locus4_f2_L1)./length1;
            locus5_f2_relL1 = (locus5_f2_L1)./length1;
            
            locus1_f2_relL2 = (locus1_f2_L2)./length2;
            locus2_f2_relL2 = (locus2_f2_L2)./length2;
            locus3_f2_relL2 = (locus3_f2_L2)./length2;
            locus4_f2_relL2 = (locus4_f2_L2)./length2;
            locus5_f2_relL2 = (locus5_f2_L2)./length2;
            
            %fluor3 normalized axes
            locus1_f3_relL1 = (locus1_f3_L1)./length1;
            locus2_f3_relL1 = (locus2_f3_L1)./length1;
            locus3_f3_relL1 = (locus3_f3_L1)./length1;
            locus4_f3_relL1 = (locus4_f3_L1)./length1;
            locus5_f3_relL1 = (locus5_f3_L1)./length1;
            
            locus1_f3_relL2 = (locus1_f3_L2)./length2;
            locus2_f3_relL2 = (locus2_f3_L2)./length2;
            locus3_f3_relL2 = (locus3_f3_L2)./length2;
            locus4_f3_relL2 = (locus4_f3_L2)./length2;
            locus5_f3_relL2 = (locus5_f3_L2)./length2;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %clist = gateTool( clist, 'add3Dt' ); %duplicate line 442?
...
% the first variable is the description, the second is the variable to
...
setter = [{'Cell ID'},{'ID'},0,1;
    ...
    {'Focus1(3) long axis birth'},{'locus3_L1'},0,1;
    {'Focus1(3) short axis birth'},{'locus3_L2'},0,0;
    {'Focus1(3) score birth'},{'locus3_s'},0,1;
    {'Focus1(3) intensity birth'},{'locus3_i'},0,0;
    {'Focus1(4) long axis birth'},{'locus4_L1'},0,1;
    {'Focus1(4) short axis birth'},{'locus4_L2'},0,0;
    {'Focus1(4) score birth'},{'locus4_s'},0,1;
    {'Focus1(4) intensity birth'},{'locus4_i'},0,0;
    {'Focus1(5) long axis birth'},{'locus5_L1'},0,1;
    {'Focus1(5) short axis birth'},{'locus5_L2'},0,0;
    {'Focus1(5) score birth'},{'locus5_s'},0,1;
    ...
    {'Focus1(1) long axis normalized'},{'locus1_relL1'},0,1;
    {'Focus1(2) long axis normalized'},{'locus2_relL1'},0,1;
    {'Focus1(3) long axis normalized'},{'locus3_relL1'},0,1;
    {'Focus1(4) long axis normalized'},{'locus4_relL1'},0,1;
    {'Focus1(5) long axis normalized'},{'locus5_relL1'},0,1;
    ...
    {'Progenitor'},{'prog'},0,0; %101

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %add channel2 values to clist 
    {'Focus2(1) long axis birth'},{'locus1_f2_L1'},0,1; %102 
    {'Focus2(1) short axis birth'},{'locus1_f2_L2'},0,1;
    {'Focus2(1) score birth'},{'locus1_f2_s'},0,1;
    {'Focus2(1) intensity birth'},{'locus1_f2_i'},0,1; %the 2 after 'Focus' indicates fluor2
    
    {'Focus2(2) long axis birth'},{'locus2_f2_L1'},0,1; %106
    {'Focus2(2) short axis birth'},{'locus2_f2_L2'},0,1;
    {'Focus2(2) score birth'},{'locus2_f2_s'},0,1;
    {'Focus2(2) intensity birth'},{'locus2_f2_i'},0,1;
    
    {'Focus2(3) long axis birth'},{'locus3_f2_L1'},0,1; %110
    {'Focus2(3) short axis birth'},{'locus3_f2_L2'},0,1;
    {'Focus2(3) score birth'},{'locus3_f2_s'},0,1;
    {'Focus2(3) intensity birth'},{'locus3_f2_i'},0,1;
    
    {'Focus2(4) long axis birth'},{'locus4_f2_L1'},0,1; %114
    {'Focus2(4) short axis birth'},{'locus4_f2_L2'},0,1;
    {'Focus2(4) score birth'},{'locus4_f2_s'},0,1;
    {'Focus2(4) intensity birth'},{'locus4_f2_i'},0,1;
    
    {'Focus2(5) long axis birth'},{'locus5_f2_L1'},0,1; %118
    {'Focus2(5) short axis birth'},{'locus5_f2_L2'},0,1;
    {'Focus2(5) score birth'},{'locus5_f2_s'},0,1;
    {'Focus2(5) intensity birth'},{'locus5_f2_i'},0,1;

    %add channel3 values to clist
    {'Focus3(1) long axis birth'},{'locus1_f3_L1'},0,1; %122
    {'Focus3(1) short axis birth'},{'locus1_f3_L2'},0,1;
    {'Focus3(1) score birth'},{'locus1_f3_s'},0,1;
    {'Focus3(1) intensity birth'},{'locus1_f3_i'},0,1;
    
    {'Focus3(2) long axis birth'},{'locus2_f3_L1'},0,1; %126
    {'Focus3(2) short axis birth'},{'locus2_f3_L2'},0,1;
    {'Focus3(2) score birth'},{'locus2_f3_s'},0,1;
    {'Focus3(2) intensity birth'},{'locus2_f3_i'},0,1;
    
    {'Focus3(3) long axis birth'},{'locus3_f3_L1'},0,1; %130
    {'Focus3(3) short axis birth'},{'locus3_f3_L2'},0,1;
    {'Focus3(3) score birth'},{'locus3_f3_s'},0,1;
    {'Focus3(3) intensity birth'},{'locus3_f3_i'},0,1;
    
    {'Focus3(4) long axis birth'},{'locus4_f3_L1'},0,1; %134
    {'Focus3(4) short axis birth'},{'locus4_f3_L2'},0,1;
    {'Focus3(4) score birth'},{'locus4_f3_s'},0,1;
    {'Focus3(4) intensity birth'},{'locus4_f3_i'},0,1;
    
    {'Focus3(5) long axis birth'},{'locus5_f3_L1'},0,1; %138
    {'Focus3(5) short axis birth'},{'locus5_f3_L2'},0,1;
    {'Focus3(5) score birth'},{'locus5_f3_s'},0,1;
    {'Focus3(5) intensity birth'},{'locus5_f3_i'},0,1;
    
    %normalized axis
    {'Focus2(1) long axis normalized'},{'locus1_f2_relL1'},0,1; %142
    {'Focus2(2) long axis normalized'},{'locus2_f2_relL1'},0,1;
    {'Focus2(3) long axis normalized'},{'locus3_f2_relL1'},0,1;
    {'Focus2(4) long axis normalized'},{'locus4_f2_relL1'},0,1;
    {'Focus2(5) long axis normalized'},{'locus5_f2_relL1'},0,1;
    {'Focus2(1) short axis normalized'},{'locus1_f2_relL2'},0,0;
    {'Focus2(2) short axis normalized'},{'locus2_f2_relL2'},0,0;
    {'Focus2(3) short axis normalized'},{'locus3_f2_relL2'},0,0;
    {'Focus2(4) short axis normalized'},{'locus4_f2_relL2'},0,0;
    {'Focus2(5) short axis normalized'},{'locus5_f2_relL2'},0,0;
    
    {'Focus3(1) long axis normalized'},{'locus1_f3_relL1'},0,1; %152
    {'Focus3(2) long axis normalized'},{'locus2_f3_relL1'},0,1;
    {'Focus3(3) long axis normalized'},{'locus3_f3_relL1'},0,1;
    {'Focus3(4) long axis normalized'},{'locus4_f3_relL1'},0,1;
    {'Focus3(5) long axis normalized'},{'locus5_f3_relL1'},0,1;
    {'Focus3(1) short axis normalized'},{'locus1_f3_relL2'},0,0;
    {'Focus3(2) short axis normalized'},{'locus2_f3_relL2'},0,0;
    {'Focus3(3) short axis normalized'},{'locus3_f3_relL2'},0,0;
    {'Focus3(4) short axis normalized'},{'locus4_f3_relL2'},0,0;
    {'Focus3(5) short axis normalized'},{'locus5_f3_relL2'},0,0;
    
    {'Long axis length'},{'length1'},0,1; %162
    {'Short axis length'},{'length2'},0,0;
    %{'Long axis length normalized'},{'rel_len'},0,1; %not correct calc
