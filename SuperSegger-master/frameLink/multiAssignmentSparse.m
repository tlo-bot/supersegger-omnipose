function [assignments,errorR,dA,revAssign,totCost,indexC,indexF]  = multiAssignmentSparse ...
...
if ~isempty(data_c)
    ...
    if ~isempty(data_f)
        ...
        binarymask = ~(data_c.regs.regs_label==0);
        maskBgFill = imfill(binarymask, 'holes');
